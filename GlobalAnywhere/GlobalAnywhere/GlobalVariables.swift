...
class GlobalVariables: NSObject {
    static let networkSimpsonsURL = "http://api.duckduckgo.com/?q=simpsons+characters&format=json"
    static let networkWireURL = "http://api.duckduckgo.com/?q=the+wire+characters&format=json"
